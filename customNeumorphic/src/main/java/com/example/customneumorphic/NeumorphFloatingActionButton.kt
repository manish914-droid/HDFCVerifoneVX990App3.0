...
import com.example.customneumorphic.internal.util.NeumorphResources
...
class NeumorphFloatingActionButton @JvmOverloads constructor(
    ...
    init {
        ...
        val fillColor =
            a.getColorStateList(R.styleable.NeumorphFloatingActionButton_neumorph_backgroundColor)
        val strokeColor =
            a.getColorStateList(R.styleable.NeumorphFloatingActionButton_neumorph_strokeColor)
        val strokeWidth =
            a.getDimension(R.styleable.NeumorphFloatingActionButton_neumorph_strokeWidth, 0f)
        val lightSource = a.getInt(
            R.styleable.NeumorphFloatingActionButton_neumorph_lightSource,
            LightSource.DEFAULT
        )
        val shapeType = a.getInt(
            R.styleable.NeumorphFloatingActionButton_neumorph_shapeType,
            ShapeType.DEFAULT
        )
