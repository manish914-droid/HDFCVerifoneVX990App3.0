...
class NeumorphImageButton @JvmOverloads constructor(
    ...
    init {
        ...
        val fillColor =
            a.getColorStateList(R.styleable.NeumorphImageButton_neumorph_backgroundColor)
        ...
        val lightSource =
            a.getInt(R.styleable.NeumorphImageButton_neumorph_lightSource, LightSource.DEFAULT)
        val shapeType = a.getInt(
            R.styleable.NeumorphImageButton_neumorph_shapeType,
            ShapeType.DEFAULT
        )
