...
public class SerialDataControl implements Parcelable {
    ...
    private final int baudRate; // 请参考ExternalSerialConst中波特率相关参数进行设置
    private final int dataBits; // 请参考ExternalSerialConst中数据位相关参数进行设置
    private final int stopBits; // 请参考ExternalSerialConst中停止位相关参数进行设置
    private final int serialParity; // 请参考ExternalSerialConst中奇偶校验位相关参数进行设置
